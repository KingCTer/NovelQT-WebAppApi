...
class ChapterSearchPagingSource(
    private val service: SearchService,
    private val query: String
) : PagingSource<Int, DataChapterSearch>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, DataChapterSearch> {
        val pageNumber = params.key ?: STARTING_PAGE_INDEX
        return try {
            val response = service.getChapterSearch(pageNumber, NETWORK_PAGE_SIZE, query)
    ...
    override fun getRefreshKey(state: PagingState<Int, DataChapterSearch>): Int? {
